...
class V2exSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        question_time = self.convert_to_mysql_datetime(question_time) if question_time else None
        ...
        if no_comments_yet:
            ...
            last_reply_time = self.convert_to_mysql_datetime(last_reply_time) if last_reply_time else None
    ...
    def convert_to_mysql_datetime(self, datetime_str):
        try:
